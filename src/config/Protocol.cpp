...
ModuleNode::ModuleNode(String id, int code) : ProtocolNode(id, code) {
...
ServoNode::ServoNode(String id, int code) : ProtocolNode(id, code) {
...
UltraSoundNode::UltraSoundNode(String id, int code) : ProtocolNode(id, code) {
  children["get_distance"] = ProtocolLeaf("get_distance", 1);
}

PIDNode::PIDNode(String id, int code) : ProtocolNode(id, code) {
...
NovaNode::NovaNode(String id, int code) : ProtocolNode(id, code) {
  children["set_mode"] = ProtocolLeaf("set_mode", 1);
  children["servo1"] = ServoNode("servo1", 1);
  children["servo2"] = ServoNode("servo2", 2);
  children["servo3"] = ServoNode("servo3", 3);
...
ExternalInputNode::ExternalInputNode(String id, int code) : ProtocolNode(id, code) {
  children["servo1"] = ServoNode("servo1", 1);
  children["servo2"] = ServoNode("servo2", 2);
  children["servo3"] = ServoNode("servo3", 3);
  children["servo4"] = ServoNode("servo4", 4);
...
KeepDistanceNode::KeepDistanceNode(String id, int code) : ProtocolNode(id, code) {
...
TrackObjectNode::TrackObjectNode(String id, int code) : ProtocolNode(id, code) {
